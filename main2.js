...
function calculateTotal() {
    ...
    var anxietyLevel = '';
    if (totalMarks >= 0 && totalMarks <= 7) {
        anxietyLevel = 'Normal';
    } else if (totalMarks >= 8 && totalMarks <= 9) {
        anxietyLevel = 'Mild Anxiety';
    } else if (totalMarks >= 10 && totalMarks <= 14) {
        anxietyLevel = 'Moderate Anxiety';
    }
    else if (totalMarks >= 15 && totalMarks <= 19) {
        anxietyLevel = 'Severe Anxiety';
    } 
    else {
        anxietyLevel = 'Extremely Severe Anxiety';
    }

    // Display the total marks and stress level
    var totalMarksElement = document.getElementById("totalMarks");
    totalMarksElement.innerText = "Total Marks: " + totalMarks + ", Anxiety Level: " + anxietyLevel;
    totalMarksElement.style.display = "block";
